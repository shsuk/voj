...
<%@ attribute name="aes256" type="java.lang.String" description="aes256 으로 암호화할 필드 예) f1,f2"%>
<%@ attribute name="sha256" type="java.lang.String" description="sha256 으로 인코딩할 필드 예) f1,f2"%>
...
<%@ attribute name="desc" type="java.lang.String" description="설명"%>
{
	...
	<c:if test="${!empty(sha256)}">sha256: '${sha256}', </c:if>
