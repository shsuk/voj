...
[
	<uf:job id="${req._t== 'r' ? 'item' : 'items' }" jobId="db" query="${req._q }" singleRow="${req._t=='r'}" isReturn="${req._t!='l' }">
		defaultValues:{
			listCount:10, 
			pageNo:1,
	...
	<uf:job id="data" jobId="list2array" src="items" skip="${req._t!='l' }">
		removeColumn:['totcount', 'pageno', 'listcount', 'tot_count']
	</uf:job>
]
</uf:organism>${JSON }
