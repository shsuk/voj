...
<uf:organism desc="사용방법은 다음 URL 참조 at.sh?_ps=admin/test_menu" noException="false">
[
	<uf:job id="rows" jobId="db" ds="dDs"  query="ac/mng/mng_list" isReturn="true" defaultValues="{listCount:10, pageNo:1}"/>
]
</uf:organism>${JSON }
