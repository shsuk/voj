...
public class AppResponseCommerceTimerTask extends ImplTimerTask {

	public void execute()throws Exception{
		List<LowerCaseMap<String, Object>> list = DbUtils.select("sl/sch/app_res_com_list", new HashMap<String, Object>());
	...
	public void work(Map<String, Object> row)throws Exception{
		...
		params.put("cid", row.get("cid"));
		params.put("hcid", row.get("hcid"));
		int count = DbUtils.update("sl/sch/app_res_com_update", params);
		if(count < 1){
